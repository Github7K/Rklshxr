...
::  Thanks to M.Uzair for the powershell method and solving special characters issue in file path name.
...
echo:           
echo:                      ◇────────────────────◇
echo:                       IDM Activarion Script
echo:                      ◇────────────────────◇
call :_color2 %_White% "        " %_Green% "                 Create By M.Uzair"           
...
If not defined name set name=M.Uzair
...
::  Written by M.Uzair
::  "Reg_Own Lean And Mean Snippet.bat"
...
__________________________________________________________________________________________________
   ...
   @M.Uzair		- Original researcher of this IDM trial reset and activation logic,
			  made an Autoit tool for these methods,
                         
   @M.Uzair	- Ported the above Autoit tool to a batch script

   @M.Uzair	- Snippet to set registry ownership and permission recursively

   M.Uzair		- Awesome batch script tricks and help

   @M.Uzair		- Set buffer height independently of window height

   @M.Uzair (Me)	- Add and fix some missing features.

   @M.Uzair  		- Changed set name to prompt for a name

   @M.Uzair		- Added a cute goldfish art in the main menu.
   
_________________________________

   IDM Activation Script
   
   Homepage:	https://Uzair.net
